...
Download the [`docker-intro.zip`](https://github.com/dme-forks/2020-09-11-docker-introduction/raw/gh-pages/docker-intro.zip) file, move it to your Desktop and unzip it. It should unzip to a folder named `docker-intro`. 
